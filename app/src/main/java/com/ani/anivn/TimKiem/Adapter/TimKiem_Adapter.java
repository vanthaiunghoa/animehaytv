package com.ani.anivn.TimKiem.Adapter;
...
public class TimKiem_Adapter extends RecyclerView.Adapter<TimKiem_Adapter.MyViewHolder> {

    List<TimKiem_Model> itemsList;
    Context context;
    AppCompatActivity activity;
    ProgressBar progressBar;

    public TimKiem_Adapter(Context context, List<TimKiem_Model> itemsList, ProgressBar progressBar) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        final TimKiem_Model film = itemsList.get(position);
