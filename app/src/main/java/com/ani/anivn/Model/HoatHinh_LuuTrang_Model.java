 ...
 */
@Entity
public class HoatHinh_LuuTrang_Model {
    @Id(autoincrement = true)
    private Long idsql;
    private String trang; // vi du cac trang 1 2 3 4 5 6
    private String tranghientai;  // vi du trang 1
    private int index_list;
    @Generated(hash = 1585715990)
    public HoatHinh_LuuTrang_Model(Long idsql, String trang, String tranghientai,
            int index_list) {
        this.idsql = idsql;
        this.trang = trang;
    ...
    @Generated(hash = 324154677)
    public HoatHinh_LuuTrang_Model() {
    }
