...
@Entity
public class CNAnimation_Model {
    ...
    private int index_list; // index cua cac the loai trong CN ANimation
    @Generated(hash = 2012124905)
    public CNAnimation_Model(Long idsql, String tenphim, String tap, String hinhanh,
    ...
    @Generated(hash = 432847167)
    public CNAnimation_Model() {
    }
