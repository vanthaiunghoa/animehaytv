 ...
 */
@Entity
public class NamPhatHanh_Model {
    ...
    @Generated(hash = 1196865436)
    public NamPhatHanh_Model(Long idsql, String tenphim, String tap, String hinhanh,
    ...
    @Generated(hash = 1660620067)
    public NamPhatHanh_Model() {
    }
