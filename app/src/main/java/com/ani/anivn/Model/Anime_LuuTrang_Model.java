 ...
 */
@Entity
public class Anime_LuuTrang_Model {
    @Id(autoincrement = true)
    private Long idsql;
    private String trang; // vi du cac trang 1 2 3 4 5 6
    private String tranghientai;  // vi du trang 1
    private int index_list;
    @Generated(hash = 375266562)
    public Anime_LuuTrang_Model(Long idsql, String trang, String tranghientai,
            int index_list) {
        this.idsql = idsql;
        this.trang = trang;
    ...
    @Generated(hash = 1025575313)
    public Anime_LuuTrang_Model() {
    }
