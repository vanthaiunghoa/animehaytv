...
public class NamPhatHanh_Adapter extends RecyclerView.Adapter<NamPhatHanh_Adapter.MyViewHolder> {

    List<NamPhatHanh_Model> itemsList;
    Context context;
    AppCompatActivity activity;
    ProgressBar progressBar;

    public NamPhatHanh_Adapter(Context context, List<NamPhatHanh_Model> itemsList, ProgressBar progressBar) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        final NamPhatHanh_Model film = itemsList.get(position);
