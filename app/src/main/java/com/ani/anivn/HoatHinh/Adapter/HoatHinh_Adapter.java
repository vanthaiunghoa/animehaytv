...
public class HoatHinh_Adapter extends RecyclerView.Adapter<HoatHinh_Adapter.MyViewHolder> {

    List<HoatHinh_Model> itemsList;
    Context context;
    AppCompatActivity activity;
    ProgressBar progressBar;

    public HoatHinh_Adapter(Context context, List<HoatHinh_Model> itemsList, ProgressBar progressBar) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        final HoatHinh_Model film = itemsList.get(position);
