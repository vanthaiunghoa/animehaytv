...
public class Anime_Adapter extends RecyclerView.Adapter<Anime_Adapter.MyViewHolder> {

    List<Anime_Model> itemsList;
    Context context;
    AppCompatActivity activity;
    ProgressBar progressBar;

    public Anime_Adapter(Context context, List<Anime_Model> itemsList, ProgressBar progressBar) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        final Anime_Model film = itemsList.get(position);
