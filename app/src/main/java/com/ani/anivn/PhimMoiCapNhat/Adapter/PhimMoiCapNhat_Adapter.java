package com.ani.anivn.PhimMoiCapNhat.Adapter;
...
public class PhimMoiCapNhat_Adapter extends RecyclerView.Adapter<PhimMoiCapNhat_Adapter.MyViewHolder> {

    List<PhimMoiCapNhat_Model> itemsList;
    Context context;
    AppCompatActivity activity;
    ProgressBar progressBar;

    public PhimMoiCapNhat_Adapter(Context context, List<PhimMoiCapNhat_Model> itemsList, ProgressBar progressBar) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        final PhimMoiCapNhat_Model film = itemsList.get(position);
