...
public class Get_HoatHinh {
    Context context;

    static final String[] listURL = {"http://animehay.tv/the-loai/phim-hoat-hinh?page=",
            "http://animehay.tv/the-loai/phim-hoat-hinh/my?page=",
            "http://animehay.tv/the-loai/phim-hoat-hinh/han-quoc?page=",
            "http://animehay.tv/the-loai/phim-hoat-hinh/malaysia?page=",
            "http://animehay.tv/the-loai/phim-hoat-hinh/anh?page=",
            "http://animehay.tv/the-loai/phim-hoat-hinh/phap?page=",
            "http://animehay.tv/the-loai/phim-hoat-hinh/dai-loan?page=",
            "http://animehay.tv/the-loai/phim-hoat-hinh/khac?page="};

    public Get_HoatHinh(Context context) {
        this.context = context;
    }

    public interface HoatHinh_Callback {
        void onSuccess(List<HoatHinh_Model> list_data, List<HoatHinh_LuuTrang_Model> list_trang);

        void onFail(String message);
    }

    public void HoatHinh(final int index_list, final String trang, final HoatHinh_ModelDao dao, final HoatHinh_LuuTrang_ModelDao luutrang_dao, final Get_HoatHinh.HoatHinh_Callback callback) {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            List<HoatHinh_Model> list_data = new ArrayList<>();
                            List<HoatHinh_LuuTrang_Model> list_trang = new ArrayList<>();
                            ...
                            if (elements_film != null) {
                                for (Element item : elements_film) {
                                    ...
                                    if (a != null) {
                                        ...
                                        HoatHinh_Model p = new HoatHinh_Model();
                                ...
                                if (li_sotrang != null) {
                                    ...
                                    for (Element st : li_sotrang) {
                                        ...
                                        if (st_a != null) {
                                            ...
                                            HoatHinh_LuuTrang_Model c = new HoatHinh_LuuTrang_Model();
                                            c.setTrang(page);
